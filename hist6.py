...
# Introduce ImageDraw and ImageFont within PIL
# ImageDraw allows drawing on an Image object, and
# ImageFont allows selecting a font to type text with
...
def compose_histogram(image, timetuple):
...
if __name__ == '__main__':
    # Open the image
    filename = "2013-10-01-16-17-12.jpg"
    skyimg = Image.open("{0}".format(filename))
    timetuple = filename.split(".")[0].split("-")
    
    histimg = compose_histogram(skyimg, timetuple)
