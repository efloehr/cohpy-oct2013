...
# Introduce matplotlib to create histogram
# Show weird syntax of subplot, plotting lines with plot,
# filling area under line with fill_between
#
# Also show saving an image not to a disk file but to
# a memory file using cStringIO which creates a file-like
# object that is a string (which can contain all bytes)
...
if __name__ == '__main__':
    ...
    histimg = get_histogram_graph_image(skyimg)
