...
# Introduce headless operation of Matplotlib and
# optimize adding text by pulling out the ImageFont creation,
# since it only has to be done once, and not once per image.
...
# Allow "headless" operation (i.e. no graphical display)
import matplotlib.pyplot as plt
import matplotlib
matplotlib.use('Agg')

# Must do the above before importing pyplot
import matplotlib.pyplot as plt
